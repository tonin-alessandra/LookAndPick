...
public class VrEyeTextView extends ViewGroup {
     ...
     *
     * @param color The integer value of the color chosen for the text.
     */
     ...
     *
     * @param text The string of text that the TextView will show.
     */
     ...
     * animation starts.
     *
     * @param alpha The alpha of the text in the TextView.
     */
     ...
     *
     * @param offset The value of the offset to set to the TextView.
     */
    ...
    /**
     * Assigns a size and a position to each of the ViewGroup's children.
     *
