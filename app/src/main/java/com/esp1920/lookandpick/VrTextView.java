...
public class VrTextView extends LinearLayout {
    ...
    private AlphaAnimation fadingAnimation;
    private static final long TOAST_DURATION = 10000;
    ...
    public VrTextView(Context context, AttributeSet attrs) {
        ...
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, 0.5f);
        ...
        fadingAnimation = new AlphaAnimation(1.0f, 0.0f);
        fadingAnimation.setDuration(TOAST_DURATION);
    }

    public void showVrToast(String text) {
        setText(text);
        setAlpha(1.0f);
        fadingAnimation.setAnimationListener(new EndAnimationListener() {
            @Override
            public void onAnimationEnd(Animation animation) {
                setAlpha(0.0f);
            }
        });
        startAnimation(fadingAnimation);
    }

    public void showVrText(String text){
        setText(text);
    }
